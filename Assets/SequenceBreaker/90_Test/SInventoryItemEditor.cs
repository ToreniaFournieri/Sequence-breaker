...
{
    public class SInventoryItemEditor : EditorWindow {

        public SInventoryItemList inventoryItemList;
        private int viewIndex = 1;
        
        [MenuItem ("Window/Inventory Item Editor %#e")]
        static void  Init () 
        {
            EditorWindow.GetWindow (typeof (SInventoryItemEditor));
        }
        ...
        void  OnEnable () {
            if(EditorPrefs.HasKey("ObjectPath")) 
            {
                ...
                inventoryItemList = AssetDatabase.LoadAssetAtPath (objectPath, typeof(SInventoryItemList)) as SInventoryItemList;
            }
        ...
        void CreateNewItemList () 
        {
            ...
            {
                inventoryItemList.itemList = new List<SInventoryItem>();
        ...
        void OpenItemList () 
        {
            ...
            if (absPath.StartsWith(Application.dataPath)) 
            {
                ...
                inventoryItemList = AssetDatabase.LoadAssetAtPath (relPath, typeof(SInventoryItemList)) as SInventoryItemList;
                if (inventoryItemList.itemList == null)
                    inventoryItemList.itemList = new List<SInventoryItem>();
                if (inventoryItemList) {
                    EditorPrefs.SetString("ObjectPath", relPath);
        ...
        void AddItem () 
        {
            SInventoryItem newItem = new SInventoryItem();
