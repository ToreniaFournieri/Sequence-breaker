...
{
    public class HomeResManager : MonoBehaviour
    {
        public Sprite[] spriteObjArray;
        // Use this for initialization
        static HomeResManager _instance = null;

        string[] _mWordList;

        Dictionary<string, Sprite> _spriteObjDict = new Dictionary<string, Sprite>();

        public static HomeResManager Get
        {
            get
            {
                if (_instance == null)
                {
                    _instance = Object.FindObjectOfType<HomeResManager>();
                }
                return _instance;
            }
