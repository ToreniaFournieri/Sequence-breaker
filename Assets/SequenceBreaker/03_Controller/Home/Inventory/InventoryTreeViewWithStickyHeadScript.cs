...
using SequenceBreaker._03_Controller.Home.Inventory.layout;
using UnityEngine;
using UnityEngine.UI;

namespace SequenceBreaker._03_Controller.Home.Inventory
{
    public sealed class InventoryTreeViewWithStickyHeadScript : MonoBehaviour
    {
       ...
       */
            ...
            InventoryTreeViewItemData treeViewItemData = InventoryTreeViewDataSourceMgr.Get.GetItemDataByIndex(treeItemIndex);
