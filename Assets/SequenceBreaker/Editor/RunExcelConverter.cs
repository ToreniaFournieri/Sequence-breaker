...
namespace SequenceBreaker.Editor
{
    public class RunExcelConverter : EditorWindow
    {
        ...
        void ConvertUnitListFromExcel()
        {
            ...
            //itemPresetList = AssetDatabase.LoadAssetAtPath(itemListPath, typeof(ItemPresetList)) as UnitClassList;
            ...
            foreach (UnitMasterExcel unitMasterExcel in unitMasterExcelImport.unitMaster)
            {
                ...
                foreach (var unitEquip in unitMasterExcelImport.unitEquipment)
                {
                    if (_unit.uniqueId == unitEquip.uniqueId)
                    {
                        ...
                        if (unitEquip.equipment1 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment1, 0, unitEquip.enhanced1)); }
                        if (unitEquip.equipment2 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment2, 0, unitEquip.enhanced2)); }
                        if (unitEquip.equipment3 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment3, 0, unitEquip.enhanced3)); }
                        if (unitEquip.equipment4 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment4, 0, unitEquip.enhanced4)); }
                        if (unitEquip.equipment5 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment5, 0, unitEquip.enhanced5)); }
                        if (unitEquip.equipment6 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment6, 0, unitEquip.enhanced6)); }
                        if (unitEquip.equipment7 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment7, 0, unitEquip.enhanced7)); }
                        if (unitEquip.equipment8 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment8, 0, unitEquip.enhanced8)); }
                        if (unitEquip.equipment9 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment9, 0, unitEquip.enhanced9)); }
                        if (unitEquip.equipment10 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment10, 0, unitEquip.enhanced10)); }
                        if (unitEquip.equipment11 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment11, 0, unitEquip.enhanced11)); }
                        if (unitEquip.equipment12 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment12, 0, unitEquip.enhanced12)); }
                        if (unitEquip.equipment13 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment13, 0, unitEquip.enhanced13)); }
                        if (unitEquip.equipment14 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment14, 0, unitEquip.enhanced14)); }
                        if (unitEquip.equipment15 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment15, 0, unitEquip.enhanced15)); }
                        if (unitEquip.equipment16 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment16, 0, unitEquip.enhanced16)); }
                        if (unitEquip.equipment17 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment17, 0, unitEquip.enhanced17)); }
                        if (unitEquip.equipment18 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment18, 0, unitEquip.enhanced18)); }
                        if (unitEquip.equipment19 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment19, 0, unitEquip.enhanced19)); }
                        if (unitEquip.equipment20 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment20, 0, unitEquip.enhanced20)); }
                        if (unitEquip.equipment21 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment21, 0, unitEquip.enhanced21)); }
                        if (unitEquip.equipment22 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment22, 0, unitEquip.enhanced22)); }
                        if (unitEquip.equipment23 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment23, 0, unitEquip.enhanced23)); }
                        if (unitEquip.equipment24 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment24, 0, unitEquip.enhanced24)); }
                        if (unitEquip.equipment25 != 0) { itemPreset.itemIdList.Add(itemIdSet.Add(0, unitEquip.equipment25, 0, unitEquip.enhanced25)); }
