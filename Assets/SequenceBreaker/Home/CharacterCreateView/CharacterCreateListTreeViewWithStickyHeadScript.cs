...
{
    public sealed class CharacterCreateListTreeViewWithStickyHeadScript : MonoBehaviour
    {
        ...
        public CharacterCreateListItemSubTitle mStickeyHeadItem;
        ...
        void Start()
        {
            ...
            CharacterCreateListTreeViewDataSourceMgr.Get.Init();
            int count = CharacterCreateListTreeViewDataSourceMgr.Get.TreeViewItemCount;

            //tells mTreeItemCountMgr there are how many TreeItems and every TreeItem has how many ChildItems.
            for (int i = 0; i < count; ++i)
            {
                int childCount = CharacterCreateListTreeViewDataSourceMgr.Get.GetItemDataByIndex(i).ChildCount;
       ...
       */
            ...
            CharacterCreateListTreeViewItemData treeViewItemData = CharacterCreateListTreeViewDataSourceMgr.Get.GetItemDataByIndex(treeItemIndex);
            ...
            if (countData.IsChild(index) == false)// if is a TreeItem
            {
                ...
                CharacterCreateListItemSubTitle itemScript = item.GetComponent<CharacterCreateListItemSubTitle>();
            ...
            else// if is a TreeChildItem
            {
                ...
                CharacterCreateListItemContent itemScript;
                //CharacterStatusCell characterStatus;

                loopListItem = listView.NewListViewItem("Content");
                itemScript = loopListItem.GetComponent<CharacterCreateListItemContent>();
        ...
        void UpdateStickeyHeadPos()
        {
            ...
            {
                CharacterCreateListTreeViewItemData treeViewItemData = CharacterCreateListTreeViewDataSourceMgr.Get.GetItemDataByIndex(itemIndex);
