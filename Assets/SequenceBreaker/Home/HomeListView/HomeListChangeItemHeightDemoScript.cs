...
{
    public class HomeListChangeItemHeightDemoScript : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            mLoopListView.InitListView(HomeListDataSourceMgr.instance.TotalItemCount, OnGetItemByIndex);
        ...
        {
            if (index < 0 || index >= HomeListDataSourceMgr.instance.TotalItemCount)
            {
                return null;
            }
        ...
        void OnAddItemBtnClicked()
        {
            ...
            if (count < 0 || count > HomeListDataSourceMgr.instance.TotalItemCount)
            {
                return;
            }
