...
namespace SequenceBreaker.Home.HomeListView
{
    ...
    public class HomeListDataSourceMgr : MonoBehaviour
    {

        List<HomeListContentData> _mItemDataList = new List<HomeListContentData>();
        ...
        //Home contents
        public HomeListContents homeListContents;

        private bool _isHomeContentsNotNull;

        public static HomeListDataSourceMgr instance = null;
        ...
        public void Init()
        {
            ...
            _isHomeContentsNotNull = homeListContents != null;

            DoRefreshDataSource();
        }

        public HomeListContentData GetItemDataByIndex(int index)
        {
        ...
        public HomeListContentData GetItemDataById(int itemId)
        {
        ...
        {
            HomeListContentData tData1 = _mItemDataList[index1];
            HomeListContentData tData2 = _mItemDataList[index2];
        ...
        public void InsertData(int index, HomeListContentData data)
        {
